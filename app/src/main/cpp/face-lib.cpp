...
JNIEXPORT void JNICALL Java_com_eltherbiometric_ui_facerecog_NativeMethods_TrainFaces(JNIEnv, jobject, jlong addrImages, jlong addrClasses) {
...
JNIEXPORT void JNICALL Java_com_eltherbiometric_ui_facerecog_NativeMethods_MeasureDist(JNIEnv *env, jobject, jlong addrImage, jfloatArray minDist, jintArray minDistIndex, jfloatArray faceDist, jboolean useEigenfaces) {
    Facebase *pFacebase;
    if (useEigenfaces) {
