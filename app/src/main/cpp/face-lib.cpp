...
JNIEXPORT void JNICALL Java_id_co_biometricsproject_FaceRecognition_NativeMethods_TrainFaces(JNIEnv, jobject, jlong addrImages, jlong addrClasses) {
...
JNIEXPORT void JNICALL Java_id_co_biometricsproject_FaceRecognition_NativeMethods_MeasureDist(JNIEnv *env, jobject, jlong addrImage, jfloatArray minDist, jintArray minDistIndex, jfloatArray faceDist, jboolean useEigenfaces) {
    Facebase *pFacebase;
    if (useEigenfaces) {
